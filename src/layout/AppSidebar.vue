<template>
    ...
    <aside class="
        ...
        <ul>
            ...
            <li>
                <RouterLink to="/pokemon-picker" class="group flex items-center space-x-4 py-3 px-4 hover:bg-[#38a172] rounded hover:text-white transition duration-200" exact-active-class="text-white bg-[#38a172]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span class="text-slate-100 group-hover:text-white font-semibold">Pokemon App</span>
                </RouterLink>
            </li>
        </ul>
    </aside>
